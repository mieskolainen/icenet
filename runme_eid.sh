...
python ./analysis/eid_train.py --config $CONFIG --datapath $DATAPATH --datasets "output_0" | tee -a "./figs/eid/$CONFIG/train_output.txt" #,1 #,2,3,4,5,6
python ./analysis/eid_eval.py  --config $CONFIG --datapath $DATAPATH --datasets "output_0" | tee -a "./figs/eid/$CONFIG/eval_output.txt" #,1 #,2,3,4,5,6
