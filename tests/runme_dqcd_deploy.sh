...
python configs/dqcd/include/ymlgen.py --process 'QCD' --filerange '[0-5]' --outputfile configs/dqcd/include/QCD_deploy.yml
...
python configs/dqcd/include/ymlgen.py --process 'vector' --filerange '[0-5]' --outputfile configs/dqcd/include/vector_deploy.yml
