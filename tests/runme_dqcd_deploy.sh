...
python configs/dqcd/include/ymlgen.py --process 'QCD' --filerange '[11-20]' --outputfile configs/dqcd/include/QCD_deploy.yml
...
python configs/dqcd/include/ymlgen.py --process 'vector' --filerange '[25-50]' --outputfile configs/dqcd/include/vector_deploy.yml
...
python configs/dqcd/include/ymlgen.py --process 'data' --filerange '[0-100]' --outputfile configs/dqcd/include/data_deploy.yml
