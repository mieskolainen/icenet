...
#python configs/dqcd/include/ymlgen.py --process 'QCD' --filerange '[50-50]' --outputfile configs/dqcd/include/QCD_deploy.yml
...
#python configs/dqcd/include/ymlgen.py --process 'vector' --filerange '[50-55]' --outputfile configs/dqcd/include/vector_deploy.yml
...
python configs/dqcd/include/ymlgen.py --process 'data' --filerange '[0-5]' --outputfile configs/dqcd/include/data_deploy.yml
