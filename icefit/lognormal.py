...
def test_lognormal():
    ...
    for i in range(len(delta_val)):
        ...
        for j in range(len(modes)):
            ...
            label = f'b_0 = {b0:0.1f}, \delta = {delta:0.2f} :: (mean,med,mode) = ({mu:0.2f}, {med:0.2f}, {mode:0.2f}), std = {std:0.2f}, std/mean = {std/mu:0.2f}, std/med = {std/med:0.2f}, std/mode = {std/mode:0.2f}'
            print(f'{label} \n')
